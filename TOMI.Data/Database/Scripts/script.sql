...
CREATE TABLE [MF2] (
    ...
    [Deletedby] uniqueidentifier NULL,
    [IsActive] bit NOT NULL,
    CONSTRAINT [PK_MF2] PRIMARY KEY ([Id])
);
GO
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedAt', N'CreatedBy', N'CustomerId', N'DeletedAt', N'Deletedby', N'Email', N'FirstName', N'IsActive', N'LastName', N'Password', N'PhoneNumber', N'Role', N'StoreId', N'UpdatedAt', N'UpdatedBy') AND [object_id] = OBJECT_ID(N'[Users]'))
    SET IDENTITY_INSERT [Users] ON;
INSERT INTO [Users] ([Id], [CreatedAt], [CreatedBy], [CustomerId], [DeletedAt], [Deletedby], [Email], [FirstName], [IsActive], [LastName], [Password], [PhoneNumber], [Role], [StoreId], [UpdatedAt], [UpdatedBy])
VALUES ('b74ddd14-6340-4840-95c2-db12554843e5', NULL, NULL, 'b74ddd14-6340-4840-95c2-db12554843e5', NULL, NULL, N'admin@gmail.com', N'Admin', CAST(0 AS bit), N'Admin', N'AQAAAAEAACcQAAAAEMBe0L+hHG2i7Vp9EY1M7MkiLcKXR6hF4PzxkynZ/hW/E6aIhvT79qE9e+X3TYc+IA==', N'1234567890', N'SuperAdmin', NULL, NULL, NULL);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedAt', N'CreatedBy', N'CustomerId', N'DeletedAt', N'Deletedby', N'Email', N'FirstName', N'IsActive', N'LastName', N'Password', N'PhoneNumber', N'Role', N'StoreId', N'UpdatedAt', N'UpdatedBy') AND [object_id] = OBJECT_ID(N'[Users]'))
...
VALUES (N'20220214125340_tomiInitial', N'5.0.13');
GO

    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MF2", x => x.Department);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MF1", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MF1_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MF1_MF2_Department",
                        column: x => x.Department,
                        principalTable: "MF2",
                        principalColumn: "Department",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MF1_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b74ddd14-6340-4840-95c2-db12554843e5"), null, null, new Guid("b74ddd14-6340-4840-95c2-db12554843e5"), null, null, "admin@gmail.com", "987654", "Admin", false, "Admin", "AQAAAAEAACcQAAAAEB5AjFiU96h7zNjAdYh6z09+pWHRYTEF/Lyih3waV91M3RqQMp9IEyFAS+qtVsSP5Q==", "1234567890", "SuperAdmin", null, null, null });

            migrationBuilder.CreateIndex(
                name: "IX_MF1_CustomerId",
                table: "MF1",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_MF1_Department",
                table: "MF1",
                column: "Department");
